...
function buildTrend() {
  const hours = ['00:00', '01:00', '02:00', '08:00', '12:00', '16:00', '20:00', '23:00']
  const cpuValues = [52.6, 59.9, 62.8, 72.2, 71.1, 79.0, 79.7, 86.4]
  const memValues = [68.1, 72.5, 75.2, 80.4, 79.1, 85.9, 85.4, 91.3]
  return {
...
function buildHostRank(): HostRank[] {
  return [
    ...
    { host_name: 'srv-shanghai-06', room: 'B', avg_cpu: 91.8 },
    { host_name: 'srv-beijing-03', room: 'A', avg_cpu: 88.5 },
    { host_name: 'srv-hangzhou-01', room: 'E', avg_cpu: 89.2 },
    { host_name: 'srv-beijing-06', room: 'A', avg_cpu: 82.7 },
    { host_name: 'srv-guangzhou-03', room: 'C', avg_cpu: 82.4 },
    ...
    { host_name: 'srv-shenzhen-01', room: 'D', avg_cpu: 72.5 },
  ]
}
...
function buildRadar(): RadarAbility[] {
  return [
    ...
    { dimension: '网络入流量', value: 285.6, max: 600 },
    { dimension: '磁盘IO等待', value: 18.5, max: 40 },
  ]
}
...
function buildAlerts(): AlertItem[] {
  return [
    ...
    { host_name: 'srv-hangzhou-01', room: 'E', mod_name: 'CPU使用率', value: 89.2, unit: '%', collect_time: '2026-07-01 12:00:00' },
    { host_name: 'srv-shanghai-06', room: 'B', mod_name: 'CPU使用率', value: 91.8, unit: '%', collect_time: '2026-07-01 20:00:00' },
    { host_name: 'srv-beijing-03', room: 'A', mod_name: '磁盘IO等待', value: 31.2, unit: 'ms', collect_time: '2026-07-01 08:00:00' },
    ...
    { host_name: 'srv-hangzhou-01', room: 'E', mod_name: '磁盘使用率', value: 94.6, unit: '%', collect_time: '2026-07-01 23:00:00' },
    { host_name: 'srv-beijing-03', room: 'A', mod_name: '磁盘使用率', value: 95.1, unit: '%', collect_time: '2026-07-01 08:00:00' },
  ]
}
